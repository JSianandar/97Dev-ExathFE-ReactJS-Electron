    ...
    handleSubmit = async(event) =>{
        ...
        axios.put('http://exath.io/api/tasks/update/all', {
            ...
            try {
                ...
                notifySuccess('Success - Monitor Delay updated to ' + this.state.monitorDelay, 3000)
                await new Promise(r => setTimeout(r, 1000))
                notifySuccess('Success - Retry Delay updated to ' + this.state.retryDelay, 3000)
                await new Promise(r => setTimeout(r, 1000))
                this.props.refreshPage()
            }
        }, error => {
            notifyError('Error while updating tasks delay data..', 3000)
        })
    }
